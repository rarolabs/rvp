...
package br.com.rarolabs.rvp.api.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class SayHi extends MyApiRequest<br.com.rarolabs.rvp.api.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, br.com.rarolabs.rvp.api.myApi.model.MyBean.class);
  ...
  public class SayHi2 extends MyApiRequest<br.com.rarolabs.rvp.api.myApi.model.Rede> {
    ...
    protected SayHi2(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, br.com.rarolabs.rvp.api.myApi.model.Rede.class);
      this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
    }
